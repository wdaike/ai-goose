...
| [OpenAI Codex](https://github.com/openai/codex) (`codex`) | Uses goose's embedded Codex App Server runtime with native threads, tools, sandboxing, and session state. | Codex authentication |
