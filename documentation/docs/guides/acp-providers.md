...
description: Use ACP agents like Claude Code, Amp, and Pi as goose providers with extension support
---
...
ACP providers let you use goose with existing agent subscriptions. They are the recommended replacement for deprecated third-party [CLI providers](/docs/guides/cli-providers).
:::
...
- The ACP agent binary is installed and in your PATH (`amp-acp`, `claude-agent-acp`, `pi-acp`, or `copilot`)
